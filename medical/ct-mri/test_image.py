...
##multi-focus 大小为520*520
	...
	if 'ct' in  infrared_path:
		...
		file_name = 'fusion_' + fusion_type + '_' + str(index) + ssim_weight_str + "_"+infrared_path[-11:-4] + '_pre.png'

	else:
		# file_name = 'fusion_' + fusion_type + '_' + str(index) + ssim_weight_str + "_"+infrared_path[-9:-6] + '_pre.png'
